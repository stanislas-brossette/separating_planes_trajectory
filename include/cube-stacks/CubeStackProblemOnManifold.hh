...
class CubeStackProblemOnManifold : public pgs::Problem
{
 public:
  ...
  void cstrAllCubeAboveFixedPlan(RefMat out,
                                 const mnf::ConstSubPoint& pointAllCubes,
                                 const double& distPlan,
                                 const Eigen::Vector3d& normal) const;

  void cstrCubeAboveFixedPlanDiff(RefMat out, const Cube& cube,
                                  const Eigen::Vector3d& normal) const;
