...
#include <cube-stacks/PointCloudStackProblemOnManifold.hh>
...
{
PointCloudStackProblemOnManifold::PointCloudStackProblemOnManifold(
...
Eigen::VectorXd PointCloudStackProblemOnManifold::findInitPoint()
{
...
CartesianProduct* PointCloudStackProblemOnManifold::buildManifold(Index nCubes)
{
...
void PointCloudStackProblemOnManifold::getTangentLB(RefVec out) const
{
...
void PointCloudStackProblemOnManifold::getTangentUB(RefVec out) const
{
  assert(out.size() == M().tangentDim() && "wrong size");
  double infinity = std::numeric_limits<double>::infinity();
...
void PointCloudStackProblemOnManifold::evalObj(double& out) const
{
  out = 0;
  for (size_t i = 0; i < nCubes_; ++i)
  {
...
void PointCloudStackProblemOnManifold::evalObjDiff(RefMat out) const
{
...
void PointCloudStackProblemOnManifold::evalLinCstr(RefVec /*out*/, size_t /*i*/) const
{
  //assert(i < numberOfCstr() && "This constraint index is out of bounds");
  //assert(out.size() == linCstrDim(i) && "wrong size");
}

void PointCloudStackProblemOnManifold::evalLinCstrDiff(RefMat /*out*/, size_t /*i*/) const
{
  //assert(i < numberOfCstr() && "This constraint index is out of bounds");
...
void PointCloudStackProblemOnManifold::getLinCstrLB(RefVec /*out*/, size_t /*i*/) const
{
  //assert(i < numberOfCstr() && "This constraint index is out of bounds");
  //assert(out.size() == linCstrDim(i) && "wrong size");
}

void PointCloudStackProblemOnManifold::getLinCstrUB(RefVec /*out*/, size_t /*i*/) const
{
  //assert(i < numberOfCstr() && "This constraint index is out of bounds");
  //assert(out.size() == linCstrDim(i) && "wrong size");
}

void PointCloudStackProblemOnManifold::evalNonLinCstr(RefVec out, size_t i) const
{
  assert(i < numberOfCstr() && "This constraint index is out of bounds");
...
void PointCloudStackProblemOnManifold::evalNonLinCstrDiff(RefMat out, size_t i) const
{
  assert(i < numberOfCstr() && "This constraint index is out of bounds");
...
void PointCloudStackProblemOnManifold::getNonLinCstrLB(RefVec out, size_t i) const
{
  assert(i < numberOfCstr() && "This constraint index is out of bounds");
  assert(out.size() == nonLinCstrDim(i) && "wrong size");
  if (i < cubeAboveFixedPlanCstrs_.size())
...
void PointCloudStackProblemOnManifold::getNonLinCstrUB(RefVec out, size_t i) const
{
  assert(i < numberOfCstr() && "This constraint index is out of bounds");
  assert(out.size() == nonLinCstrDim(i) && "wrong size");
  if (i < cubeAboveFixedPlanCstrs_.size())
...
size_t PointCloudStackProblemOnManifold::numberOfCstr() const
{
...
Index PointCloudStackProblemOnManifold::linCstrDim(size_t) const { return 0; }

Index PointCloudStackProblemOnManifold::nonLinCstrDim(size_t i) const
{
  if (i < cubeAboveFixedPlanCstrs_.size())
    return 8;
  else
...
std::string PointCloudStackProblemOnManifold::getCstrName(const size_t i) const
{
  return cstrNames_[i];
}

void PointCloudStackProblemOnManifold::fileForMatlab(std::string fileName,
                                       const Point& x) const
{
  std::ofstream myFile;
